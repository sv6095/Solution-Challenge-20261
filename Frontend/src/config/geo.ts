...
export const INTEL_HOTSPOTS: any[] = [
  {
    id: 'sahel',
    name: 'Sahel',
...
export const STRATEGIC_WATERWAYS: any[] = [
...
export const CONFLICT_ZONES: any[] = [
  {
    id: 'iran',
...
function mergeAndDeduplicateBases(): any[] {
...
export const MILITARY_BASES: any[] = mergeAndDeduplicateBases();
...
export const UNDERSEA_CABLES: any[] = [
  // === TRANS-ATLANTIC ===
  {
    id: 'marea',
    name: 'MAREA',
...
export const NUCLEAR_FACILITIES: any[] = [
...
export const ECONOMIC_CENTERS: any[] = [
  // Americas
...
export const CRITICAL_MINERALS: any[] = [
  // Lithium
